...
public class Main {
    ...
    public static void printPoints(double[] arr_x,double[] arr_y){
        for(int i=0;i<arr_x.length;i++){
            System.out.print("["+arr_x[i]+";"+arr_y[i]+"] ");
        }
    }

    public static double findPointsGreatestDistance(double[] xCoord, double[] yCoord){
    ...
    public static int[] findPointsIndex(double[] arr_x, double[] arr_y){
        double currDistance =0;
        double max = 0;
        int index[]=new int[2];
        for(int i=0;i<arr_x.length;i++) {

...
public class BankAccount {
    ...
    protected void setNameOfCustomer(String nameOfCustomer){
        if(nameOfCustomer !=null && !nameOfCustomer.isEmpty()) {
            this.nameOfCustomer = nameOfCustomer;
        }
    }

    protected String getNameOfCustomer(){
    ...
    protected boolean isPositiveBalance(){
        return balance>0;
    }


    protected boolean isNegativeBalance(){
        return balance<0;
    }


    protected void newMoney(double money){
        if(!isBlockBalance){
            balance+=money;
        }else{
            System.out.println("\nРазблакируйте счет!");

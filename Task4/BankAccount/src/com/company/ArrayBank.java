...
public class ArrayBank {
    ...
    protected void setProcessOfBankAccount(BankAccount[] arr) {
    ...
    protected BankAccount[] getArrayOfAccounts() {
        return arrayOfAccounts;
    }

    protected BankAccount getBankAccount(int index) {
    ...
    protected void getRandomBankAccounts(String[] name, int[] arrayBalance) {
    ...
    protected void blockAllBankAccounts() {
    ...
    protected void block(String str, double balance) {
        int count = 0;
    ...
    protected double getTotalNegativeBalance() {
        double total = 0;
        for (BankAccount account : arrayOfAccounts) {
    ...
    protected double getTotalPositiveBalance() {
        double total = 0;
        for (BankAccount account : arrayOfAccounts) {
    ...
    protected void sortByNameOfCustomer() {
        int time;
    ...
    protected void findCustomerByNameAndBalance(String name) {
    ...
    protected void findCustomerBalance(double balance) {
        int num = 0;
    ...
    protected ArrayBank findCustomerByNameAndBalance(String name, double balance) {
        int count = 0;
    ...
    protected void addBankAccount(String name, double deposit) {
    ...
    protected void deleteBankAccountByName(String name) {
    ...
    protected void withdrawMoney(double money, int indexOfAccount) {
    ...
    protected void depositMoney(double money, int indexOfAccount) {
        if (indexOfAccount >= 0 && indexOfAccount < getSize()) {

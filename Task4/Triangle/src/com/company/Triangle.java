...
class Triangle {
    ...
    protected static Point createObjectPoint(double x, double y) {
        Point newPoint = new Point(x, y);
        return newPoint;
    }

    protected static void getCenter(Point v1, Point v2, Point v3) {
    ...
    protected static double perimeter(double a, double b, double c) {
        double p = a + b + c;
    ...
    protected static double calculateSideOfTriangle(Point v2, Point v1) {

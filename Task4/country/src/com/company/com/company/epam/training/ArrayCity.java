...
public class ArrayCity {
    ...
    public void ArrayRegion(int size) {
        if (size > 0) {
    ...
    public void ArrayDistrict(int size) {
        if (size > 0) {
    ...
    public void runCity(String[] arrayOfCityName, String[] arrayRegions, String[] arrayDistricts, int[] regionSquare) {

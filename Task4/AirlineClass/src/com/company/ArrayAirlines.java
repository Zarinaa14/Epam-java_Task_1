...
public class ArrayAirlines {

    private Airline[] arrayOfAirlines;
    Random random = new Random();

    public ArrayAirlines(int size) {
        if (size > 0) {
    ...
    public ArrayAirlines(Airline[] array) {
        setArrayOfAirlines(array);
    }

    protected void setArrayOfAirlines(Airline[] array) {
        if (array != null) {
    ...
    protected Airline[] getArrayOfAirlines() {
    ...
    protected void addAirline(Airline airline) {
        if (airline != null) {
    ...
    protected void getFlightsForDay(String day, String time) {
        for (Airline airline : arrayOfAirlines) {
    ...
    public boolean equals(Object obj) {
        ...
        ArrayAirlines other = (ArrayAirlines) obj;

...
public class Main {
    public static void main(String[] args) {
        ...
        Point v1 = Triangle.createObjectPoint(x1, y1);
        Point v2 = Triangle.createObjectPoint(x2, y2);
        Point v3 = Triangle.createObjectPoint(x3, y3);

        //Point v1 = new Point(1.0D, 1.0D);
        //Point v2 = new Point(2.0D, 4.0D);
        //Point v3 = new Point(3.0D, 2.0D);
        double v2v1 = Triangle.calculateSideOfTriangle(v2, v1);
        double v3v2 = Triangle.calculateSideOfTriangle(v3, v2);
        double v3v1 = Triangle.calculateSideOfTriangle(v3, v1);
        ...
        if (triangle.isExistTriangle() == true) {
            ...
            Triangle.getCenter(v1, v2, v3);
            double perimeter = Triangle.perimeter(v2v1, v3v2, v3v1);

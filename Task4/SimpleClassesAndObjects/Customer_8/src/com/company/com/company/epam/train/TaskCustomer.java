...
public class TaskCustomer {
    ...
    public void runCustomer(String[] surname, String[] name, String[] patronymic, String[] adress, int[] numCreditCard, int[] numberBankAccount) {
        for (int i = 0; i < 4; i++) {
    ...
    public void sortCustombersByCredit(int startOfMerge, int endOfMerge) {

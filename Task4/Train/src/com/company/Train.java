...
public class Train {
    ...
    public Train(){
        nameOfTheDestination="not defined";
    ...
    protected void setNameOfTheDestination(String nameOfTheDestination){
        if(nameOfTheDestination!=null && !nameOfTheDestination.isEmpty()) {
            this.nameOfTheDestination = nameOfTheDestination;
        }
    }

    protected void setDepartureTime(int departureTime){
        if(departureTime>0) {
            departureTime = departureTime;
        }
    }
    protected void setNumberOfTrain(int numberOfTrain){
        if(numberOfTrain>0) {
            numberOfTrain = numberOfTrain;
        }
    }
    protected static Train[] sortByNumberOfTrain(Train[] arrayOfTrain) {

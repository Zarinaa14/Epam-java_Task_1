...
public class MagicSquare {
    public void swapTwoArrayElements(int[] array, final int INDEX1, final int INDEX2) {
    ...
    public void outputArrayAsMatrix(int[] array) {
        final int SIZE = (int) Math.sqrt(array.length);
    ...
    public void generateMagic(final int SIZE) {
        if (SIZE <= 0) {
